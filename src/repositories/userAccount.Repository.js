...
export const deleteRole = async (login, role) => UserAccount.findByIdAndUpdate(login, {$pull: {roles: role}}, {returnDocument: 'after'}).exec();

export const changePassword = async (login, password) => UserAccount.findByIdAndUpdate(login, password);
